...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size) {
    ...
    switch (selector) {
    case 0: tapiru::fuzz_key_event(payload, payload_size); break;
    case 1: tapiru::fuzz_mouse_event(payload, payload_size); break;
    case 2: tapiru::fuzz_resize_event(payload, payload_size); break;
    }
