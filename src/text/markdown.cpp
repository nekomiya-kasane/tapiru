...
std::string syntax_highlight(std::string_view code, std::string_view language) {
    ...
    static const std::unordered_set<std::string> cpp_keywords = {
        ...
        "delete",    "do",       "else",     "enum",      "explicit", "extern",   "false",     "for",      "friend",
        "goto",      "if",       "inline",   "namespace", "new",      "noexcept", "nullptr",   "operator", "private",
        "protected", "public",   "return",   "sizeof",    "static",   "struct",   "switch",    "template", "this",
        "throw",     "true",     "try",      "typedef",   "typename", "using",    "virtual",   "void",     "volatile",
        "while",     "int",      "float",    "double",    "char",     "bool",     "long",      "short",    "unsigned",
        "signed",    "include",  "define",   "ifdef",     "ifndef",   "endif",    "pragma",    "override", "final",
