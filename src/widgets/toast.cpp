...
node_id toast_builder::flatten_into(detail::scene& s) const {
    ...
    std::string prefix;
    switch (state_->level()) {
        case toast_level::info:    sty = &info_sty_;    prefix = "\xe2\x84\xb9 ";  break;  // ℹ
        case toast_level::success: sty = &success_sty_; prefix = "\xe2\x9c\x93 ";  break;  // ✓
        case toast_level::warning: sty = &warning_sty_; prefix = "\xe2\x9a\xa0 ";  break;  // ⚠
        case toast_level::error:   sty = &error_sty_;   prefix = "\xe2\x9c\x97 ";  break;  // ✗
    }
