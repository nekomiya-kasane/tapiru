...
namespace tapiru::detail {
    ...
    static_assert(sizeof(g_widget_ops) / sizeof(g_widget_ops[0]) == static_cast<size_t>(widget_type::count_));
    ...
    inline void dispatch_render(scene &s, node_id id, canvas &c, rect area, const style_table &styles) {
