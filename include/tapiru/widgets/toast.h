...
enum class toast_level : uint8_t {
...
public:
    ...
    toast_builder& state(const toast_state* s)       { state_ = s; return *this; }
    toast_builder& info_style(const style& s)        { info_sty_ = s; return *this; }
    toast_builder& success_style(const style& s)     { success_sty_ = s; return *this; }
    toast_builder& warning_style(const style& s)     { warning_sty_ = s; return *this; }
    toast_builder& error_style(const style& s)       { error_sty_ = s; return *this; }
    toast_builder& border(border_style bs)           { border_ = bs; return *this; }
    toast_builder& z_order(int16_t z)                { z_order_ = z; return *this; }
