...
public:
    ...
    popup_builder& anchor(popup_anchor a) { anchor_ = a; return *this; }
    popup_builder& dim_background(float opacity) { dim_ = opacity; return *this; }
    popup_builder& border(border_style bs) { border_ = bs; return *this; }
    popup_builder& border_style_override(const style& s) { border_sty_ = s; return *this; }
    popup_builder& title(std::string_view t) { title_ = t; return *this; }
    popup_builder& z_order(int16_t z) { z_order_ = z; return *this; }
