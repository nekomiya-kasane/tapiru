...
namespace tapiru {
    ...
    class TAPIRU_API line_chart_builder {
      public:
        ...
        line_chart_builder &min_val(float v) {
            min_ = v;
            has_min_ = true;
            return *this;
        }
        line_chart_builder &max_val(float v) {
            max_ = v;
            has_max_ = true;
            return *this;
        }
        line_chart_builder &style_override(const style &s) {
            style_ = s;
            return *this;
        }
        line_chart_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
        line_chart_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
    ...
    class TAPIRU_API bar_chart_builder {
      public:
        ...
        bar_chart_builder &labels(std::vector<std::string> lbl) {
            labels_ = std::move(lbl);
            return *this;
        }
        bar_chart_builder &style_override(const style &s) {
            style_ = s;
            return *this;
        }
        bar_chart_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
        bar_chart_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
    ...
    class TAPIRU_API scatter_builder {
      public:
        ...
        scatter_builder &style_override(const style &s) {
            style_ = s;
            return *this;
        }
        scatter_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
        scatter_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
