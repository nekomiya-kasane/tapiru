...
class TAPIRU_API menu_item_builder {
  public:
    ...
    menu_item_builder &shortcut(std::string_view s) {
        shortcut_ = s;
        return *this;
    }
    menu_item_builder &disabled(bool v = true) {
        disabled_ = v;
        return *this;
    }
    menu_item_builder &checked(bool v = true) {
        checked_ = v;
        return *this;
    }
    menu_item_builder &icon(std::string_view i) {
        icon_ = i;
        return *this;
    }
...
class TAPIRU_API menu_state {
  public:
    ...
    // ── Mouse operations ──
    void hover(int depth, int item_index, int mouse_x, int mouse_y, const menu_tree &tree);
...
class TAPIRU_API menu_builder {
  public:
    ...
    menu_builder &cursor(const int *c) {
        cursor_ = c;
        return *this;
    }
    menu_builder &state(const menu_state *s) {
        state_ = s;
        return *this;
    }
    menu_builder &border(border_style bs) {
        border_ = bs;
        return *this;
    }
    menu_builder &border_style_override(const style &s) {
        border_sty_ = s;
        return *this;
    }
    menu_builder &highlight_style(const style &s) {
        highlight_sty_ = s;
        return *this;
    }
    menu_builder &shortcut_style(const style &s) {
        shortcut_sty_ = s;
        return *this;
    }
    menu_builder &item_style(const style &s) {
        item_sty_ = s;
        return *this;
    }
    menu_builder &disabled_style(const style &s) {
        disabled_sty_ = s;
        return *this;
    }
    menu_builder &z_order(int16_t z) {
        z_order_ = z;
        return *this;
    }
