...
namespace tapiru {
    ...
    class TAPIRU_API text_builder {
      public:
        ...
        text_builder &align(justify j) {
            align_ = j;
            return *this;
        }
        text_builder &overflow(overflow_mode m) {
            overflow_ = m;
            return *this;
        }
        text_builder &style_override(const style &s) {
            style_ = s;
            has_style_ = true;
            return *this;
        }
        text_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        text_builder &key(std::string_view k) {
    ...
    class TAPIRU_API rule_builder {
      public:
        ...
        rule_builder &title(std::string_view t) {
            title_ = t;
            return *this;
        }
        rule_builder &align(justify j) {
            align_ = j;
            return *this;
        }
        rule_builder &character(char32_t ch) {
            ch_ = ch;
            return *this;
        }
        rule_builder &rule_style(const style &s) {
            style_ = s;
            return *this;
        }
        rule_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        rule_builder &gradient(const linear_gradient &g) {
            gradient_ = g;
            return *this;
        }
        rule_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
    ...
    class TAPIRU_API padding_builder {
      public:
        template <typename B>
        explicit padding_builder(B &&content)
        ...
        padding_builder &pad(uint8_t all) { return pad(all, all, all, all); }
        padding_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        padding_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
    ...
    class TAPIRU_API panel_builder {
      public:
        template <typename B>
        explicit panel_builder(B &&content)
            : content_(std::make_unique<model<std::decay_t<B>>>(std::forward<B>(content))) {}
        ...
        panel_builder &border(border_style bs) {
            border_ = bs;
            return *this;
        }
        panel_builder &border_style_override(const style &s) {
            border_sty_ = s;
            return *this;
        }
        panel_builder &title(std::string_view t) {
            title_ = t;
            return *this;
        }
        panel_builder &title_style(const style &s) {
            title_sty_ = s;
            return *this;
        }
        panel_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        panel_builder &opacity(float o) {
            alpha_ = static_cast<uint8_t>(o < 0.f ? 0 : o > 1.f ? 255 : o * 255.f);
            return *this;
        }
        panel_builder &background_gradient(const linear_gradient &g) {
            bg_gradient_ = g;
            return *this;
        }
        panel_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
        ...
        panel_builder &shader(shader_fn fn) {
            shader_ = std::move(fn);
            return *this;
        }
    ...
    class TAPIRU_API columns_builder {
      public:
        ...
        template <typename B> columns_builder &add(B &&child, uint32_t flex = 0) {
            children_.push_back(std::make_unique<model<std::decay_t<B>>>(std::forward<B>(child)));
            flex_ratios_.push_back(flex);
            return *this;
        }

        columns_builder &gap(uint32_t g) {
            gap_ = g;
            return *this;
        }
        columns_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        columns_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
        columns_builder &opacity(float o) {
            alpha_ = static_cast<uint8_t>(o < 0.f ? 0 : o > 1.f ? 255 : o * 255.f);
            return *this;
        }
    ...
    class TAPIRU_API table_builder {
      public:
        ...
        table_builder &border(border_style bs) {
            border_ = bs;
            return *this;
        }
        table_builder &border_style_override(const style &s) {
            border_sty_ = s;
            return *this;
        }
        table_builder &header_style(const style &s) {
            header_sty_ = s;
            return *this;
        }
        table_builder &show_header(bool v = true) {
            show_header_ = v;
            return *this;
        }
        table_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        table_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
        ...
        table_builder &border_gradient(const linear_gradient &g) {
            border_gradient_ = g;
            return *this;
        }
    ...
    class TAPIRU_API overlay_builder {
      public:
        ...
        overlay_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        overlay_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
        overlay_builder &opacity(float o) {
            alpha_ = static_cast<uint8_t>(o < 0.f ? 0 : o > 1.f ? 255 : o * 255.f);
            return *this;
        }
    ...
    class TAPIRU_API rows_builder {
      public:
        ...
        template <typename B> rows_builder &add(B &&child, uint32_t flex = 0) {
            children_.push_back(std::make_unique<model<std::decay_t<B>>>(std::forward<B>(child)));
            flex_ratios_.push_back(flex);
            return *this;
        }

        rows_builder &gap(uint32_t g) {
            gap_ = g;
            return *this;
        }
        rows_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        rows_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
        rows_builder &opacity(float o) {
            alpha_ = static_cast<uint8_t>(o < 0.f ? 0 : o > 1.f ? 255 : o * 255.f);
            return *this;
        }
    ...
    class TAPIRU_API spacer_builder {
      public:
        ...
        spacer_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        spacer_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
    ...
    class TAPIRU_API sized_box_builder {
      public:
        template <typename B>
        explicit sized_box_builder(B &&content)
            : content_(std::make_unique<model<std::decay_t<B>>>(std::forward<B>(content))) {}
        ...
        sized_box_builder &width(uint32_t w) {
            fixed_w_ = w;
            return *this;
        }
        sized_box_builder &height(uint32_t h) {
            fixed_h_ = h;
            return *this;
        }
        sized_box_builder &min_width(uint32_t w) {
            min_w_ = w;
            return *this;
        }
        sized_box_builder &min_height(uint32_t h) {
            min_h_ = h;
            return *this;
        }
        sized_box_builder &max_width(uint32_t w) {
            max_w_ = w;
            return *this;
        }
        sized_box_builder &max_height(uint32_t h) {
            max_h_ = h;
            return *this;
        }
        sized_box_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        sized_box_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
    ...
    class TAPIRU_API center_builder {
      public:
        template <typename B>
        explicit center_builder(B &&content)
            : content_(std::make_unique<model<std::decay_t<B>>>(std::forward<B>(content))) {}
        ...
        center_builder &horizontal_only() {
            horizontal_ = true;
            vertical_ = false;
            return *this;
        }
        center_builder &vertical_only() {
            horizontal_ = false;
            vertical_ = true;
            return *this;
        }
        center_builder &z_order(int16_t z) {
            z_order_ = z;
            return *this;
        }
        center_builder &key(std::string_view k) {
            key_ = detail::fnv1a_hash(k);
            return *this;
        }
