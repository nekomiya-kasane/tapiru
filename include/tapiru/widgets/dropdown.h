...
class TAPIRU_API dropdown_builder {
  public:
    ...
    dropdown_builder &selected(const int *idx) {
        selected_ = idx;
        return *this;
    }
    dropdown_builder &open(const bool *o) {
        open_ = o;
        return *this;
    }
    dropdown_builder &placeholder(std::string_view p) {
        placeholder_ = p;
        return *this;
    }
    dropdown_builder &button_style(const style &s) {
        button_sty_ = s;
        return *this;
    }
    dropdown_builder &highlight_style(const style &s) {
        highlight_sty_ = s;
        return *this;
    }
    dropdown_builder &item_style(const style &s) {
        item_sty_ = s;
        return *this;
    }
    dropdown_builder &border(border_style bs) {
        border_ = bs;
        return *this;
    }
    dropdown_builder &width(uint32_t w) {
        width_ = w;
        return *this;
    }
    dropdown_builder &z_order(int16_t z) {
        z_order_ = z;
        return *this;
    }
