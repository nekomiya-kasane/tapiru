...
public:
    ...
    keybinding_builder& key_style(const style& s)        { key_sty_ = s; return *this; }
    keybinding_builder& desc_style(const style& s)       { desc_sty_ = s; return *this; }
    keybinding_builder& separator(std::string_view sep)  { separator_ = sep; return *this; }
    keybinding_builder& z_order(int16_t z)               { z_order_ = z; return *this; }
