...
public:
    ...
    scroll_view_builder& viewport_width(uint32_t w)  { view_w_ = w; return *this; }
    scroll_view_builder& viewport_height(uint32_t h) { view_h_ = h; return *this; }
    scroll_view_builder& scroll_x(const int* px)     { scroll_x_ = px; return *this; }
    scroll_view_builder& scroll_y(const int* py)     { scroll_y_ = py; return *this; }
    scroll_view_builder& show_scrollbar_v(bool v = true) { scrollbar_v_ = v; return *this; }
    scroll_view_builder& show_scrollbar_h(bool v = true) { scrollbar_h_ = v; return *this; }
    scroll_view_builder& border(border_style bs)     { border_ = bs; return *this; }
    scroll_view_builder& border_style_override(const style& s) { border_sty_ = s; return *this; }
    scroll_view_builder& z_order(int16_t z)          { z_order_ = z; return *this; }
