    ...
    namespace detail {
        ...
        class tqdm_bar {
          public:
            ...
            void init(size_t total, const std::string &desc, int bar_width, const std::string &unit, bool disable,
                      bool leave, int miniters, double mininterval, color colour, FILE *file) {
                total_ = total;
                desc_ = desc;
                ...
                if (total_ > 0) {
                    ...
                    *p++ = ' ';
                    ...
                    if (current > 0 && current < total_) {
                        double remaining =
                            elapsed / static_cast<double>(current) * static_cast<double>(total_ - current);
